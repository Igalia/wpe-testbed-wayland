...
namespace argparse {
    ...
    public:
        ...
        virtual void help() {
            ...
            cout << endl;
            for (const auto &entry : arg_entries) {
                cout << setw(25) << entry->keys_[0] << " : " << entry->help << entry->info() << endl;
            }

            cout << endl << "Options:" << endl;
            for (const auto &entry : all_entries) {
                if (entry->type != Entry::ARG) {
                    cout << setw(25) << entry->_get_keys() << " : " << entry->help << entry->info() << endl;
                }
            }
        ...
        void print() const {
            for (const auto &entry : all_entries) {
                ...
                cout << setw(25) << entry->_get_keys() + snip << " : " << (entry->is_set_by_user? bold(entry->value_.value_or("null")) : entry->value_.value_or("null")) << endl;
            }
